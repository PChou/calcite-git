...
+---------+-----------------------+------------------------+-----------------+-----+--------+
|  HASH   |         TIME          |       COMMITTER        |      FILE       | ADD | REMOVE |
+---------+-----------------------+------------------------+-----------------+-----+--------+
| 788734f | 2020-03-12 00:04:56.0 | parker.zhou@eoitek.com | .gitignore      | 19  | 0      |
| 788734f | 2020-03-12 00:04:56.0 | parker.zhou@eoitek.com | pom.xml         | 81  | 0      |
| 788734f | 2020-03-12 00:04:56.0 | parker.zhou@eoitek.com | quick-model.yml | 10  | 0      |
| 788734f | 2020-03-12 00:04:56.0 | parker.zhou@eoitek.com | quick-sqlline   | 38  | 0      |
| 788734f | 2020-03-12 00:04:56.0 | parker.zhou@eoitek.com | sqlline         | 38  | 0      |
+---------+-----------------------+------------------------+-----------------+-----+--------+
# 统计所有贡献者的代码总量
...
+-----------+-------------+-------------+-------------+-----------+-----------------------+-------------+---------------+----------------+----------+
| TABLE_CAT | TABLE_SCHEM | TABLE_NAME  | COLUMN_NAME | DATA_TYPE |       TYPE_NAME       | COLUMN_SIZE | BUFFER_LENGTH | DECIMAL_DIGITS | NUM_PREC |
+-----------+-------------+-------------+-------------+-----------+-----------------------+-------------+---------------+----------------+----------+
|           | GIT         | CALCITE_GIT | HASH        | 12        | VARCHAR NOT NULL      | -1          | null          | null           | 10       |
|           | GIT         | CALCITE_GIT | TIME        | 93        | TIMESTAMP(0) NOT NULL | 0           | null          | null           | 10       |
|           | GIT         | CALCITE_GIT | COMMITTER   | 12        | VARCHAR NOT NULL      | -1          | null          | null           | 10       |
|           | GIT         | CALCITE_GIT | FILE        | 12        | VARCHAR NOT NULL      | -1          | null          | null           | 10       |
|           | GIT         | CALCITE_GIT | ADD         | 4         | INTEGER NOT NULL      | -1          | null          | null           | 10       |
|           | GIT         | CALCITE_GIT | REMOVE      | 4         | INTEGER NOT NULL      | -1          | null          | null           | 10       |
+-----------+-------------+-------------+-------------+-----------+-----------------------+-------------+---------------+----------------+----------+
```
...
```
git log --format=%h,%ct,%ce --numstat 
```
